...
const Mobile = props => (
  <tr>
    ...
    <td>
      <Link to={"/edit/"+props.mobile._id}>edit</Link> 
    </td>
  </tr>
)
    ...
    return (
      <div>
        <div>
          ...
          <NavLink activeClassName="active" style={{float: 'left'}} value="EditUserProfile" className="btn btn-primary" to="/edituser">Edit profile</NavLink>
        </div>
        <br />
